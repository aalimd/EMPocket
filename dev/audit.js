...
(async function () {
  ...
  const source = await (await fetch('../assets/app.js?v=20260910-complete-r11')).text();
  ...
  const parsed = new DOMParser().parseFromString(await (await fetch('../index.html?audit=20260910-complete-r11')).text(), 'text/html');
