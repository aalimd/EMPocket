...
const CORE_ASSETS = [
    './',
    './index.html',
    './assets/app.css?v=20260910-icon1',
    './assets/student-learning.js?v=20260910-icon1',
    './assets/app.js?v=20260910-icon1',
    './assets/data.js?v=20260910-icon1',
    './assets/evidence.js?v=20260910-icon1',
    './assets/ecg-svg.js?v=20260910-icon1',
    './assets/ecg-engine.js?v=20260910-icon1',
    './assets/ecg-case-tracings.js?v=20260910-icon1',
    './assets/ecg-interactive.js?v=20260910-icon1',
    './assets/ecg-curriculum.js?v=20260910-icon1',
  './assets/ecg-explorer.js?v=20260910-icon1'
];
const OPTIONAL_ASSETS = [
    './manifest.json?v=20260910-icon1',
    './assets/icon.svg?v=20260910-icon1',
    './assets/icon-192.png?v=20260910-icon1',
    './assets/icon-512.png?v=20260910-icon1',
    './assets/icon-maskable-512.png?v=20260910-icon1',
    './assets/apple-touch-icon.png?v=20260910-icon1'
];
